    ...
    <>
      <Container style={{marginBottom: '3em', marginTop: '1em'}}>
        <Row>
          <Col xs={{order: 'last'}} md={{order: 'first'}} xs={12}>
            <div>
              <h1>
                Hi, I'm <span className="kybutler-text">KyButler!</span>
              </h1>

              <p>
                . . . a recently graduated university student who has too much time for videogames - hopefully you'll enjoy watching me play some as
                much as I like playing them!
              </p>
            </div>
          </Col>
      ...
      <Container style={{marginBottom: '3em'}}>
        ...
        <Row>
          <Col xs={{order: 'last'}} md={{order: 'first'}} xs={12}>
            <Ratio aspectRatio="1x1">
              <iframe
                ...
                src="https://bandcamp.com/EmbeddedPlayer/track=2833081214/size=large/bgcol=333333/linkcol=fe7eaf/tracklist=false/transparent=true/"
                seamless>
          ...
          <Col xs={{order: 'first'}} md={{order: 'last'}}>
            <div>
              <h1>
                The <span className="kybutler-text">KyButler</span> Collective
              </h1>
              <hr />
              <p>
                This is a track created by{' '}
                <span className="sour-text" onClick={() => window.open('https://www.youtube.com/channel/UC1YhDvjc50ax8D_RlwdLB6Q', '_blank')}>
                  The Sour Knights
                </span>{' '}
                dedicated to, well . . . me! I love this song and I love the work that Sour puts into his music, definitely worth checking out!
              </p>
            </div>
          </Col>
        </Row>
      ...
      <Container style={{marginBottom: '10em'}}>
        ...
        <Row>
          <Col>
            <Image
              className="image-on-hover"
              onClick={() => window.open('https://www.twitch.tv/andynya', '_blank')}
        ...
        <Row>
          <Col>
            <Image
              className="image-on-hover"
              onClick={() => window.open('https://www.twitch.tv/j0hann710', '_blank')}
              style={{borderRadius: '5px', marginBottom: '1em'}}
              src={Johann710Banner}
              fluid
            />
        ...
        <Row>
          <Col>
            <Image
              className="image-on-hover"
              onClick={() => window.open('https://www.youtube.com/channel/UC1YhDvjc50ax8D_RlwdLB6Q', '_blank')}
              style={{borderRadius: '5px', marginBottom: '1em'}}
              src={SourBanner}
              fluid
            />
